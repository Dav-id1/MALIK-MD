...
global.THUMB_IMAGE = process.env.THUMB_IMAGE || 'https://telegra.ph/file/dcffdf049c7cf0ca9375b.jpg'
module.exports = {
  
  sessionName:  process.env.SESSION_ID ||  "session",
  botname:   process.env.BOT_NAME === undefined ? 'мσяту' : process.env.BOT_NAME,
